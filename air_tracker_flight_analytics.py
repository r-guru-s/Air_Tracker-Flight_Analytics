...
def fetch_flights(iata_code, start_date_time, end_date_time):
  ...
  try:
    ...
    print(f"Error fetching flights data for {iata_code} {start_date_time}→{end_date_time}: {e}")
    return None
...
print(windows)
for w in windows:
    print(f"  {w['date']} {w['label']}: {w['from']} → {w['to']}")
...
for idx, airport in enumerate(my_airports, start=1):
  ...
  for w in windows:
    ...
    if flights_data:
      ...
      print(f"  Error fetching flights data for {airport} {w['from']}→{w['to']}")
      errors += 1
...
#     ### 👨‍💻 Developer Information
#     **Created by:** [Rajaguru]
#     **GitHub:** [https://github.com/r-guru-s]
# 
#     ### 📚 Project Structure
# ```
#     air-tracker/
